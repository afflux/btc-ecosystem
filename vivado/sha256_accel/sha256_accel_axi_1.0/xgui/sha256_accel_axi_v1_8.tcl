...
proc update_MODELPARAM_VALUE.c_sha256_accel_axi_data_width { MODELPARAM_VALUE.c_sha256_accel_axi_data_width } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "c_sha256_accel_axi_data_width". Setting updated value from the model parameter.
set_property value 32 ${MODELPARAM_VALUE.c_sha256_accel_axi_data_width}
}

proc update_MODELPARAM_VALUE.c_sha256_accel_axi_addr_width { MODELPARAM_VALUE.c_sha256_accel_axi_addr_width } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "c_sha256_accel_axi_addr_width". Setting updated value from the model parameter.
set_property value 4 ${MODELPARAM_VALUE.c_sha256_accel_axi_addr_width}
}
