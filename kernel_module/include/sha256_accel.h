...
#	define SHA256_ACCEL_SET_DIFFICULTY_MASK _IOW(SHA256_ACCEL_MAGIC, 4, const unsigned char *)
...
#	define SHA256_ACCEL_GET_DEBUG _IOR(SHA256_ACCEL_MAGIC, 8, __u32 *)

#	define SHA256_ACCEL_STEP _IO(SHA256_ACCEL_MAGIC, 9)

#	define SHA256_ACCEL_SET_CLK_CTRL _IOW(SHA256_ACCEL_MAGIC, 10, const __u32)
